...
<html>
    <head>
		...
		<link href="<?php echo base_url('assets/adminlte/AdminLTE-2.0.5/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') ?>" rel="stylesheet" type="text/css">
		...
		<noscript>
			<meta http-equiv="refresh" content="0;URL=<?php echo site_url("auth/disabled"); ?>" />
		</noscript>